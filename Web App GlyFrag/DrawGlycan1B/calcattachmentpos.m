...
%         plotinfoout.CHAR = [{[],1};plotinfoout.CHAR];
%     else
%         plotinfoout.CHAR = {[],1};
%     end
end
    ...
    switch lower(options.orientation)
        case 'up'
            ...
            for i = 1:length(cbplotinfosto)
                structwidth = structwidth + max(cbplotinfosto{i}.mspos(:,1)) - min(cbplotinfosto{i}.mspos(:,1)) + 1;
            end
            horizontalfix =  (max(curlybracketcover(:,1)) + min(curlybracketcover(:,1)))/2 - (structwidth-1)/2;
            cbplotinfosto{1}.mspos(:,1) = cbplotinfosto{1}.mspos(:,1) + horizontalfix - min(cbplotinfosto{1}.mspos(:,1) - cbplotinfosto{1}.mspos(1,1));
            for i = 1:length(cbplotinfosto)
...
% addonfix(2) = (max(curlybracketcover(:,1)) + min(curlybracketcover(:,1)))/2 + (structwidth-1)/2 - (max(curlybracketcover(:,1) - curlybracketcover(1,1)));            
            addonfix(2) = (max(curlybracketcover(:,1)) + min(curlybracketcover(:,1)))/2 + (structwidth-1)/2 - (max(mainmspos(:,1) - mainmspos(1,1)));
            addonfix(2) = addonfix(2) * (addonfix(2) > 0);
%             addonfix(4) = (max(curlybracketcover(:,1)) + min(curlybracketcover(:,1)))/2 - (structwidth-1)/2 - (min(curlybracketcover(:,1) - curlybracketcover(1,1)));
addonfix(4) = (max(curlybracketcover(:,1)) + min(curlybracketcover(:,1)))/2 - (structwidth-1)/2 - (min(mainmspos(:,1) - mainmspos(1,1)));
...
%             addonfix(4) = (max(curlybracketcover(:,1)) + min(curlybracketcover(:,1)))/2 - (structwidth-1)/2 - (min(curlybracketcover(:,1) - curlybracketcover(1,1)));
        ...
        case 'left'
            ...
            for i = 1:length(cbplotinfosto)
                structwidth = structwidth + max(cbplotinfosto{i}.mspos(:,2)) - min(cbplotinfosto{i}.mspos(:,2)) + 1;
            end
            verticalfix = (max(curlybracketcover(:,2)) + min(curlybracketcover(:,2)))/2 - (structwidth-1)/2;
            cbplotinfosto{1}.mspos(:,2) = cbplotinfosto{1}.mspos(:,2) + verticalfix - min(cbplotinfosto{1}.mspos(:,2) - cbplotinfosto{1}.mspos(1,2));
            for i = 1:length(cbplotinfosto)
...
%             addonfix(1) = (max(curlybracketcover(:,2)) + min(curlybracketcover(:,2)))/2 + (structwidth-1)/2 - (max(curlybracketcover(:,2) - curlybracketcover(1,2)));
            addonfix(1) = (max(curlybracketcover(:,2)) + min(curlybracketcover(:,2)))/2 + (structwidth-1)/2 - (max(mainmspos(:,2) - mainmspos(1,2)));
            addonfix(1) = addonfix(1) * (addonfix(1) > 0);
            addonfix(3) = (max(curlybracketcover(:,2)) + min(curlybracketcover(:,2)))/2 - (structwidth-1)/2 - (min(mainmspos(:,2) - mainmspos(1,2)));
%             addonfix(3) = (max(curlybracketcover(:,2)) + min(curlybracketcover(:,2)))/2 - (structwidth-1)/2 - (min(curlybracketcover(:,2) - curlybracketcover(1,2)));
